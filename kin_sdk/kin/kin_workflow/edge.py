...
class SourceHandle(BaseModel):
    type: str = Field("", description="source handle type")
    label: str = Field("", description="source handle label")


class TargetHandle(BaseModel):
    type: str = Field("", description="target handle type")
    label: str = Field("", description="target handle label")
