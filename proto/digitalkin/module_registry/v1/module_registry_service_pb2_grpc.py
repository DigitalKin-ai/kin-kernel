...
class ModuleRegistryService(object):
    ...
    def RegisterModule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module_registry.v1.ModuleRegistryService/RegisterModule',
    ...
    def DeregisterModule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module_registry.v1.ModuleRegistryService/DeregisterModule',
    ...
    def DiscoverModule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module_registry.v1.ModuleRegistryService/DiscoverModule',
    ...
    def UpdateModuleStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module_registry.v1.ModuleRegistryService/UpdateModuleStatus',
