...
class ModuleService(object):
    ...
    def StartModule(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/digitalkin.module.v1.ModuleService/StartModule',
    ...
    def StopModule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module.v1.ModuleService/StopModule',
    ...
    def GetModuleStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module.v1.ModuleService/GetModuleStatus',
    ...
    def GetModuleInput(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module.v1.ModuleService/GetModuleInput',
    ...
    def GetModuleOutput(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module.v1.ModuleService/GetModuleOutput',
    ...
    def GetModuleSetup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/digitalkin.module.v1.ModuleService/GetModuleSetup',
