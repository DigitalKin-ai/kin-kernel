...
class Activity(_message.Message):
    __slots__ = ("id", "kin_id", "status", "subject", "workflow_name", "kin_name", "date", "duration", "price")
    ...
    price: float
    def __init__(self, id: _Optional[str] = ..., kin_id: _Optional[str] = ..., status: _Optional[str] = ..., subject: _Optional[str] = ..., workflow_name: _Optional[str] = ..., kin_name: _Optional[str] = ..., date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., duration: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., price: _Optional[float] = ...) -> None: ...
